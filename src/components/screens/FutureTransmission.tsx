        ...
        <motion.div initial={{ opacity: 0, y: 16 }} animate={{ opacity: 1, y: 0 }}
          ...
          <div style={{
            ...
            <div style={{ position: "absolute", inset: -6, borderRadius: "50%",
              background: `radial-gradient(circle, ${accent}44 0%, transparent 70%)`, filter: "blur(8px)", pointerEvents: "none" }} />
            <span style={{ filter: corruption > 0.3 ? `blur(${corruption * 1.5}px)` : "none", display: "flex", alignItems: "center", justifyContent: "center" }}>
              <UniverseIcon id={universe.id} size={62} color={universe.color} strokeWidth={1.4} />
            </span>
          </div>
