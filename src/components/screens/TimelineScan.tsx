  ...
  return (
    <div style={{
      ...
      <div style={{
        ...
        backgroundImage: "url('/universe-art/linkedout.png')",
        backgroundSize: "cover", backgroundPosition: "center",
      }} />

      {/* Spiral animation — over the photo */}
      <div style={{ position: "fixed", inset: 0, zIndex: 0, pointerEvents: "none", opacity: 0.5, mixBlendMode: "screen" }}>
        <SpiralAnimation />
      </div>
      ...
      <div style={{
        ...
        background: "radial-gradient(ellipse at 50% 50%, rgba(0,0,0,0.35) 0%, rgba(0,0,0,0.72) 100%)",
      }} />
