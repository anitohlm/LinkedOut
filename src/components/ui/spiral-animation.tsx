...
class Star {
  ...
  render(p: number, controller: AnimationController) {
    ...
    if (q > 0) {
      ...
      // Access private fields via bracket notation (compatible with the original design)
      const cameraZ = (controller as any)['cameraZ'] as number
      const viewZoom = (controller as any)['viewZoom'] as number
