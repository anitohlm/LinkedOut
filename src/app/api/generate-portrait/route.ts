...
const UNIVERSE_LOOK: Record<string, string> = {
  ...
  cyberpunk: "neon-drenched futuristic megacity at night, towering skyscrapers covered in glowing holographic signs and bokeh city lights behind, a sleek high-collar techwear jacket with intricate glowing neon-green circuitry lines, reflective cyberpunk visor, vibrant electric NEON GREEN as the dominant accent color throughout (lighting, circuitry, signage and rim light), with subtle cyan and magenta secondary glints, moody atmospheric haze",
